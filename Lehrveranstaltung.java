public class Lehrveranstaltung {
    ...
    private Vorlesungsstunde[] vorlesungsstunden = new Vorlesungsstunde[5]; //Maximale Anzahl von Vorlesungsstunden aktuell 5 (demonstrationszwecke)
    private Praktikumsstunde[] praktikumsstunden = new Praktikumsstunde[5]; //Maximale Anzahl von Praktikumsstunden aktuell 5 (demonstrationszwecke)
